...
namespace CopyItemDatasourceUpdater.Pipeline
{
    ...
    public class LayoutDataSourceReferenceUpdater
    {
        ...
        private void UpdateItemFields(Item itemBeingCopied)
        {
            ...
            if (!string.IsNullOrEmpty(layoutField.InnerField.Value) && itemBeingCopied.Languages.Any())
            {
                ...
                {
                    var versionedItem = itemBeingCopied.Database.GetItem(itemBeingCopied.ID, language, itemBeingCopied.Version);
